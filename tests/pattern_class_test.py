...
sys.path.append("/home/mdupont/experiments/astunparse/lib/") # my hack for not installing the astunparse, just pip install it.
...
def define_replace_method(methodname,args, body):
    """
    This generates an ast for a generic function that takes a list parameters and returns a generic body
